...
Los valores son normalizados dentro de límites seguros. `Enter` ejecuta inmediatamente, `Escape` limpia la búsqueda y el botón de cierre restaura el árbol normal.
