...
$lang = array(
  ...
  "Search folders and files" => "Buscar carpetas y archivos",
  "Search..." => "Buscar...",
  "Clear search" => "Limpiar búsqueda",
  "Searching..." => "Buscando...",
  "No matching folders." => "No se encontraron carpetas coincidentes.",
  "{count} matching folders." => "{count} carpetas coincidentes.",
  "{count} matching files" => "{count} archivos coincidentes",
  "Partial results: {count} matching folders." => "Resultados parciales: {count} carpetas coincidentes.",
  "{folders} matching folders and {files} files." => "{folders} carpetas y {files} archivos coincidentes.",
  "Partial results: {reason}." => "Resultados parciales: {reason}.",
  "result limit reached" => "se alcanzó el límite de resultados",
  "entry limit reached" => "se alcanzó el límite de entradas examinadas",
  "time limit reached" => "se alcanzó el límite de tiempo",
  "configured limit reached" => "se alcanzó un límite configurado",
  "Results are limited to {count} folders." => "Los resultados están limitados a {count} carpetas.",
  "Search is not enabled." => "La búsqueda no está habilitada.",
  "Invalid search query." => "La búsqueda no es válida.",
